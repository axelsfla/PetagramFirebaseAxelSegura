...
public interface IEndPointsApi {
    ...
    Call<UsuarioInstagram> registrarUsuarioID(@Field("idDispositivoFrom") String idDispositivo, @Field("idUsuarioInstagramFrom") String idUsuarioInstagram);

    @FormUrlEncoded
    @POST(ConstantesRestApi.KEY_POST_REGISTRAR_LIKE_INSTAGRAM)
    Call<UsuarioInstagram> registrarLikeInstagram(@Field("idDispositivoFrom") String idDispositivo, @Field("idUsuarioInstagramFrom") String idUsuarioInstagramFrom, @Field("idUsuarioInstagramTo") String idUsuarioInstagramTo, @Field("idFotoInstagram") String idFotoInstagram);
