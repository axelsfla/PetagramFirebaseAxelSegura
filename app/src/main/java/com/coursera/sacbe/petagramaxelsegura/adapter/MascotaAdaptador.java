...
//                intent.putExtra(activity.getResources().getString(R.string.pRaza), mascota.getRaza());
        ...
        mascotaViewHolder.btnLike.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                */
                ...
                Call<MascotaResponse> mascotaResponseCall = iEndPointsApi.setMediaLike(ConstantesRestApi.ACCESS_TOKEN, fotoMascota.getIdFoto());
                ...
                mascotaResponseCall.enqueue(new Callback<MascotaResponse>() {
                    ...
                    public void onResponse(Call<MascotaResponse> call, Response<MascotaResponse> response) {
                        ...
                        Call<UsuarioInstagram> usuarioResponseCall = endpoints.registrarLikeInstagram(idDispositivoFrom,idUsuarioInstagramFrom, idUsuarioInstagramTo, fotoMascota.getIdFoto());
    ...
    private String obtenerCuentaConfigurada(){
        ...
        String nombrePerfilActual = miPreferenciaCompartida.getString(activity.getResources().getString(R.string.pNombrePerfil), "");
