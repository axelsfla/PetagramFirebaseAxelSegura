...
public class UsuarioInstagram {
    ...
    public UsuarioInstagram(String id, String idDispositivoFrom, String idUsuarioInstagramFrom, String idDispositivoTo, String idUsuarioInstagramTo, String idFotoInstagram) {
        this.id = id;
